...
import com.wxxr.javax.transaction.InvalidTransactionException;
import com.wxxr.javax.transaction.NotSupportedException;
...
//      TransactionTimeoutConfiguration
{
   ...
   /** Instance logger. */
   private static Trace log = Trace.getLogger(TxManager.class);
