...
class ELUtil {
     ...
     * {@link #getExceptionMessageString(com.wxxr.javax.el.ELContext,java.lang.String,Object []).
     * </p>
     *
     ...
     * <code>ResourceBundle</code> "com.wxxr.javax.el.Messages" using that locale.  Get
    ...
    public static String getExceptionMessageString(ELContext context,
        ...
        if (null != locale) {
            ...
            if (null == (rb = (ResourceBundle)
                ...
                rb = ResourceBundle.getBundle("com.wxxr.javax.el.PrivateMessages",
                                              locale);
    ...
    static ExpressionFactory getExpressionFactory() {
    	if(exprFactory == null){
    		exprFactory = new ExpressionFactoryImpl();
    	}
        return exprFactory;
    }
