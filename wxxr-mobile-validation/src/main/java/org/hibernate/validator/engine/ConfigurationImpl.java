...
//	private  MessageInterpolator defaultMessageInterpolator; // = new ResourceBundleMessageInterpolator(
...
//		if ( ignoreXmlConfiguration ) {
			...
			if ( validationBootstrapParameters.messageInterpolator == null ) {
				validationBootstrapParameters.messageInterpolator = getDefaultMessageInterpolator();
			}
