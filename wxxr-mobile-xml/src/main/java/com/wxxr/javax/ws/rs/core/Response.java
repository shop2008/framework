...
public abstract class Response {
     ...
     * using a {@link com.wxxr.javax.ws.rs.ext.MessageBodyReader} that supports mapping the
     ...
     * a zero-length content, in case the <tt>{@value com.wxxr.javax.ws.rs.core.HttpHeaders#CONTENT_LENGTH}</tt> and
     * <tt>{@value com.wxxr.javax.ws.rs.core.HttpHeaders#CONTENT_TYPE}</tt> headers are specified in the message.
     ...
     * using a {@link com.wxxr.javax.ws.rs.ext.RuntimeDelegate.HeaderDelegate} if one is available via
     * {@link com.wxxr.javax.ws.rs.ext.RuntimeDelegate#createHeaderDelegate(java.lang.Class)} for the
     ...
     * {@link com.wxxr.javax.ws.rs.ext.RuntimeDelegate.HeaderDelegate} if one is available
     * via {@link com.wxxr.javax.ws.rs.ext.RuntimeDelegate#createHeaderDelegate(java.lang.Class)}
    ...
    public static abstract class ResponseBuilder {
         ...
         * @see #type(com.wxxr.javax.ws.rs.core.MediaType)
         ...
         *              using a {@link com.wxxr.javax.ws.rs.ext.RuntimeDelegate.HeaderDelegate} if
         *              one is available via {@link com.wxxr.javax.ws.rs.ext.RuntimeDelegate#createHeaderDelegate(java.lang.Class)}
