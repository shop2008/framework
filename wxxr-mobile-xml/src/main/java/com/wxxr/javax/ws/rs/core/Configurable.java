 ...
 * or {@link com.wxxr.javax.ws.rs.container.DynamicFeature} meta-providers) or can be directly represented
 * by a concrete JAX-RS component implementing the {@code Configurable} interface
 * (such as {@link com.wxxr.javax.ws.rs.client.Client} or {@link com.wxxr.javax.ws.rs.client.WebTarget}).
...
public interface Configurable<C extends Configurable> {
     ...
     * a {@link com.wxxr.javax.ws.rs.core.Feature feature} meta-provider) to be instantiated
     ...
     * meta-provider contracts, such as {@code Feature} or {@link com.wxxr.javax.ws.rs.container.DynamicFeature}.
     * <p>
