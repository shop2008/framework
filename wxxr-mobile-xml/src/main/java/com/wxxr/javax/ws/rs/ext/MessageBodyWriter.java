 ...
 * with {@link com.wxxr.javax.ws.rs.Produces} to restrict the media types for which it will
 ...
 * @author Marc Hadley
 * @see Provider
 * @see com.wxxr.javax.ws.rs.Produces
 * @since 1.0
 */
public interface MessageBodyWriter<T> {
     ...
     *                    of the returned instance. {@link com.wxxr.javax.ws.rs.core.GenericEntity}
     ...
     * @param type        the class of instance that is to be written.
     * @param genericType the type of instance to be written. {@link com.wxxr.javax.ws.rs.core.GenericEntity}
     *                    provides a way to specify this information at runtime.
     * @param annotations an array of the annotations attached to the message entity instance.
     * @param mediaType   the media type of the HTTP entity.
    ...
    public void writeTo(T t, Class<?> type, Type genericType, Annotation[] annotations,
            ...
            throws java.io.IOException, com.wxxr.javax.ws.rs.WebApplicationException;
}
