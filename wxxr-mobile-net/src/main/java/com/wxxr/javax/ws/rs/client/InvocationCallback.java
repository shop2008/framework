 ...
 *                   {@link com.wxxr.javax.ws.rs.core.Response} or the anticipated response entity
 *                   type.
...
public interface InvocationCallback<RESPONSE> {
     ...
     * <p>
     * Once this invocation callback method returns, the underlying {@link com.wxxr.javax.ws.rs.core.Response}
     ...
     * <p>
     * Note that the provided {@link Throwable} may be a {@link com.wxxr.javax.ws.rs.ProcessingException} in case the
     * invocation processing failure has been caused by a client-side runtime component error.
     * The {@code Throwable} may also be a {@link com.wxxr.javax.ws.rs.WebApplicationException} or one
     * of its subclasses in case the response status code is not
     * {@link com.wxxr.javax.ws.rs.core.Response.Status.Family#SUCCESSFUL successful} and the generic
     * callback type is not {@link com.wxxr.javax.ws.rs.core.Response}.
     * In case a processing of a properly received response fails, the wrapped processing exception
     * will be of {@link ResponseProcessingException} type and will contain the {@link com.wxxr.javax.ws.rs.core.Response}
