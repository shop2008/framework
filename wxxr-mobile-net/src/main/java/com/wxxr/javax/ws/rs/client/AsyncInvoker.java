...
public interface AsyncInvoker {
     ...
     * that wraps a {@link com.wxxr.javax.ws.rs.ProcessingException} thrown in case of an invocation processing
     * failure.
     ...
     * Note that calling the {@link java.util.concurrent.Future#get()} method on the returned
     * {@code Future} instance may throw an {@link java.util.concurrent.ExecutionException}
     * that wraps either a {@link com.wxxr.javax.ws.rs.ProcessingException} thrown in case of an invocation processing
     ...
     * </p>
     *
     * @param entity request entity, including it's full {@link com.wxxr.javax.ws.rs.core.Variant} information.
     ...
     *               the entity variant information.
     * @return invocation response {@link Future future}.
     * @throws com.wxxr.javax.ws.rs.ProcessingException
