 ...
 * {@link com.wxxr.javax.ws.rs.Path#value} for an explanation of URI templates.
 *
...
public abstract class UriBuilder {
     ...
     * root resource class.
     *
     * @param resource a root resource whose {@link com.wxxr.javax.ws.rs.Path} value will
     *                 be used to initialize the UriBuilder.
     * @return a new UriBuilder.
     * @throws IllegalArgumentException if resource is not annotated with
     *                                  {@link com.wxxr.javax.ws.rs.Path} or resource is {@code null}.
     */
    ...
    /**
     * Create a new instance representing a relative URI initialized from a
     * {@link com.wxxr.javax.ws.rs.Path}-annotated method.
     *
     * This method can only be used in cases where there is a single method with the
     * specified name that is annotated with {@link com.wxxr.javax.ws.rs.Path}.
     *
     * @param resource the resource containing the method.
     * @param method   the name of the method whose {@link com.wxxr.javax.ws.rs.Path} value will be
     ...
     *                                  {@link com.wxxr.javax.ws.rs.Path}.
     * @since 2.0
     */
     ...
     * between the existing path and the supplied path if necessary.
     *
     * @param resource a resource whose {@link com.wxxr.javax.ws.rs.Path} value will be
     *                 used to obtain the path to append.
     * @return the updated UriBuilder.
     * @throws IllegalArgumentException if resource is {@code null}, or
     *                                  if resource is not annotated with {@link com.wxxr.javax.ws.rs.Path}.
     */
    ...
    /**
     * Append the path from a {@link com.wxxr.javax.ws.rs.Path}-annotated method to the
     * existing path.
     * When constructing the final path, a '/' separator will be inserted
     * between the existing path and the supplied path if necessary.
     *
     * @param method a method whose {@link com.wxxr.javax.ws.rs.Path} value will be
     *               used to obtain the path to append to the existing path.
     * @return the updated UriBuilder.
     * @throws IllegalArgumentException if method is {@code null} or is
     *                                  not annotated with a {@link com.wxxr.javax.ws.rs.Path}.
     */
