 ...
 * creating an {@link com.wxxr.javax.ws.rs.client.Invocation.Builder} or a
 * {@link com.wxxr.javax.ws.rs.client.WebTarget}.</p>
 *
 ...
 * @see com.wxxr.javax.ws.rs.client.Client#invocation
 * @see com.wxxr.javax.ws.rs.client.Client#target(com.wxxr.javax.ws.rs.core.Link)
 * @see com.wxxr.javax.ws.rs.core.Response#getLink(java.lang.String)
 * @since 2.0
 */
public abstract class Link {
    ...
    /**
     * Convenience method that returns a {@link com.wxxr.javax.ws.rs.core.UriBuilder}
     ...
     *
     * @param resource a root resource whose {@link com.wxxr.javax.ws.rs.Path} value will be used
     *                 to initialize the builder.
     * @return a new {@link Link.Builder link builder} instance.
     * @throws IllegalArgumentException if resource is not annotated with {@link com.wxxr.javax.ws.rs.Path}
     ...
     * @param method   the name of the method whose {@link com.wxxr.javax.ws.rs.Path} value will be used
