...
public class XStream {
    ...
    public XStream(
        ...
        this(reflectionProvider, hierarchicalStreamDriver,new CompositeClassLoader());
    }
...
//    }
    ...
    private Mapper buildMapper() {
        ...
        mapper = new AnnotationMapper(mapper, converterRegistry, converterLookup, classLoaderReference, reflectionProvider, jvm);
