 ...
 *
 */
public class ViewPagerAdapterViewFieldBinder implements IFieldBinder {
	...
	public IFieldBinding createBinding(IBindingContext context,String fieldName,
		...
		return new ViewPagerAdapterViewFieldBinding((IAndroidBindingContext)context, fieldName, attrs);
	}
