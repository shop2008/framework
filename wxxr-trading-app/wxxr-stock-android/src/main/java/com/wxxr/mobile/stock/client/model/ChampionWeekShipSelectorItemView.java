...
@View(name="ChampionWeekShipSelectorItemView")
public abstract class ChampionWeekShipSelectorItemView extends ViewBase implements ItemViewSelector, IListAdapterBuilder {
	
	@Override
	public String getItemViewId(Object itemData) {
		if (itemData instanceof String) {
			return "NewsTitleItemView";
		} else if (itemData instanceof WeekRankBean) {
			return "ChampionWeekShipItemView";
		}
		return null;
	}
	...
	public String[] getAllViewIds() {
		return new String[] {"NewsTitleItemView","ChampionWeekShipItemView"};
	}
		...
		AbstractPinnedHeaderListAdapter adapter = new AbstractPinnedHeaderListAdapter(bContext,createAdaptorFromValue(field), this) {
			...
			protected boolean isHeaderData(Object data) {
				if (data instanceof String) {
					return true;
				} else if (data instanceof WeekRankBean) {
					return false;
				} 
