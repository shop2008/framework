...
public class NewDragSortListViewFieldBinding extends BasicFieldBinding implements IObservableListDataProvider{

	private IListDataProvider listAdapter;
	private IDataChangedListener listener;
	public NewDragSortListViewFieldBinding(IAndroidBindingContext ctx,
	...
	public void activate(IView model) {
		...
		if(listAdapter != null){
			((NewDragSortListView)getUIControl()).setDataProvider(this);
		}
	...
	public void deactivate() {
		if(this.listAdapter != null){
			((NewDragSortListView)getUIControl()).setDataProvider(null);
