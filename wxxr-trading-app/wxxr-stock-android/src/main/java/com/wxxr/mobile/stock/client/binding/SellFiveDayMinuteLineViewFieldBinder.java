 ...
 *
 */
public class SellFiveDayMinuteLineViewFieldBinder implements IFieldBinder {
	...
	public IFieldBinding createBinding(IBindingContext context,String fieldName,
		...
		return new SellFiveDayMinuteLineViewFieldBinding((IAndroidBindingContext)context, fieldName, attrs);
	}
