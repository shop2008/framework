...
public class ImageSwiperAdapterViewFileBinder implements IFieldBinder {
	...
	public IFieldBinding createBinding(IBindingContext context,
		...
		return new ImageSwiperAdapterViewFieldBinding((IAndroidBindingContext)context, fieldName, attrs);
	}
