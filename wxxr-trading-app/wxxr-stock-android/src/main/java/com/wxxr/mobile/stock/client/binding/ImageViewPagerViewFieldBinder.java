 ...
 *
 */
public class ImageViewPagerViewFieldBinder implements IFieldBinder {
	...
	public IFieldBinding createBinding(IBindingContext context,String fieldName,
		...
		return new ImageViewPagerViewFieldBinding((IAndroidBindingContext)context, fieldName, attrs);
	}
