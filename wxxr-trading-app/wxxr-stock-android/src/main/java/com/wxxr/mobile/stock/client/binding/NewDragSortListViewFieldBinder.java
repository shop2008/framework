 ...
 *
 */
public class NewDragSortListViewFieldBinder implements IFieldBinder {
	...
	public IFieldBinding createBinding(IBindingContext context,String fieldName,
		...
		return new NewDragSortListViewFieldBinding((IAndroidBindingContext)context, fieldName, attrs);
	}
