 ...
 * {@link SliderLayout} and the framework <code>ActionBar</code> to implement the recommended
 ...
 * with the state of the linked SliderLayout after <code>onRestoreInstanceState</code>
 * has occurred.</p>
 *
 * <p><code>ActionBarDrawerToggle</code> can be used directly as a
 * {@link SliderLayout.DrawerListener}, or if you are already providing your own listener,
 * call through to each of the listener methods from your own.</p>
 */
public class ActionBarDrawerToggle implements SliderLayout.DrawerListener {
...
//        }
    ...
    private final SliderLayout mDrawerLayout;
     ...
     *
     * <p>The given {@link Activity} will be linked to the specified {@link SliderLayout}.
     ...
     * @param sliderLayout The SliderLayout to link to the given Activity's ActionBar
     ...
     *                                  for accessibility
     */
    public ActionBarDrawerToggle(Activity activity, SliderLayout sliderLayout,
            int drawerImageRes, int openDrawerContentDescRes, int closeDrawerContentDescRes) {
        mActivity = activity;
        mDrawerLayout = sliderLayout;
    ...
    /**
     * Synchronize the state of the drawer indicator/affordance with the linked SliderLayout.
     *
     ...
     * the SliderLayout's instance state has been restored, and any other time when the state
    ...
    /**
     * {@link SliderLayout.DrawerListener} callback method. If you do not use your
     * ActionBarDrawerToggle instance directly as your SliderLayout's listener, you should call
