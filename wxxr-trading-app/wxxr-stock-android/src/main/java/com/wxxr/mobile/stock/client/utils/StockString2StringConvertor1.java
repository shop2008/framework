 ...
 * 
 */
public class StockString2StringConvertor1 implements IValueConvertor<Float, String> {

	private String format = "%+10.2f";
	private float multiple = 1.00f;
	private String formatUnit = "";
	private String nullString;
	private Float nullLong;
	...
	public void init(IWorkbenchRTContext ctx, Map<String, Object> map) {
		...
		if (map.containsKey("nullLong")) {
			this.nullLong = (Float) map.get("nullLong");
		}
	...
	public Float toSourceTypeValue(String s) throws ValidationException {
		...
		try {
			return (Float) (Float.parseFloat(s) / multiple);
