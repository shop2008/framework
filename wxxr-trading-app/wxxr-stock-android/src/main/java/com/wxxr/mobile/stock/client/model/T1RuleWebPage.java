...
@View(name="T1RuleWebPage",withToolbar=true,description="文章正文")
@AndroidBinding(type=AndroidBindingType.ACTIVITY, layoutId="R.layout.web_page_layout")
public abstract class T1RuleWebPage extends PageBase implements IModelUpdater {

	static Trace log= Trace.getLogger(T1RuleWebPage.class);
	@Menu(items = { "left" })
...
//	
	@Bean(express="${articleService.getT1TradingRuleArticle()}")
