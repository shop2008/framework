...
//	public float zHeightScale; //柱状图纵度比；
	...
	public void setStockUpColor(int stockUpColor) {
		if(stockUpColor!=0){
			...
			this.stockUpColor = GBasicLineView.STOCK_RED;
		}
	}
	...
	public void setStockDownColor(int stockDownColor) {
		if(stockDownColor!=0){
			...
			this.stockDownColor = GBasicLineView.STOCK_GREEN;
		}
	}
	...
	public void setStockAverageLineColor(int stockAverageLineColor) {
		if(stockAverageLineColor!=0){
			...
			this.stockAverageLineColor = GBasicLineView.STOCK_YELLOW;
		}
	}
	...
	public void setStockCloseColor(int stockCloseColor) {
		if(stockCloseColor!=0){
			...
			this.stockCloseColor = GBasicLineView.STOCK_WHITE;
		}
	}
	public void setBorderColor(int color) {
		if(color!=0){
			...
			this.stockBorderColor = GBasicLineView.BORDER_COLOR;
		}
	}
	...
	public void setShadowColor(int shadowColor) {
		if(shadowColor!=0){
			...
			this.shadowColor = GBasicLineView.SHADOW_COLOR;
		}
	}
