...
public class PinHeaderListViewFieldBinder implements IFieldBinder {
	...
	public IFieldBinding createBinding(IBindingContext context,
		...
		return new PinHeaderListViewFieldBinding((IAndroidBindingContext)context, fieldName, attrs);
	}
