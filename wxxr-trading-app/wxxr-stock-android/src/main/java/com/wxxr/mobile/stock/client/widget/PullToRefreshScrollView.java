...
//    private static final String TAG = "XScrollView";
    ...
    private void initWithContext(Context context) {
        mLayout = (LinearLayout) View.inflate(context, R.layout.pull_to_refresh_scrollview_layout, null);
    ...
    private void addHeaderView(RefreshHeaderView mHeaderView) {
        if (mLayout == null) {
            return;
        }
    ...
    private void addFooterView(RefreshFooterView mFooterView) {
        if (mLayout == null) {
            return;
        }
