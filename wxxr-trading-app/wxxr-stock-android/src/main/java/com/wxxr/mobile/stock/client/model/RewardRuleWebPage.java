...
@View(name="RewardRuleWebPage",withToolbar=true,description="文章正文")
@AndroidBinding(type=AndroidBindingType.ACTIVITY, layoutId="R.layout.web_page_layout")
public abstract class RewardRuleWebPage extends PageBase implements IModelUpdater {

	static Trace log= Trace.getLogger(RewardRuleWebPage.class);
	@Menu(items = { "left" })
...
//	
	@Bean(express="${articleService.getRewardRuleArticle()}")
