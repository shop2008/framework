 ...
 *
 */
public class RefreshListViewAdapterBinder implements IFieldBinder {
	...
	public IFieldBinding createBinding(IBindingContext context,String fieldName,
		...
		return new RefreshListViewAdapterBinding((IAndroidBindingContext)context, fieldName, attrs);
	}
