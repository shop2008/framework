...
public abstract class SellTDTradingPageHeaderView extends ViewBase implements IModelUpdater,ISelectionChangedListener {
	...
	@Field(valueKey="text",binding="${(tradingAccount!=null && tradingAccount.elapseTime>0 && tradingAccount.elapseTime == tradingAccount.durationDay)?'最后卖出日':utils.getDayString(tradingAccount.elapseTime)}")
	String sellDay;
