...
@View(name="TBuyTdTradingPageView",withToolbar=true, description="挑战交易盘T+D",provideSelection=true)
@AndroidBinding(type=AndroidBindingType.ACTIVITY,layoutId="R.layout.buy_td_trading_page_view")
public abstract class TBuyTdTradingPageView extends PageBase implements IModelUpdater , IEventListener{
	private static final Trace log = Trace.register(TBuyTdTradingPageView.class);
