...
public abstract class TBuyTdTradingPageHeaderView extends ViewBase implements IModelUpdater,ISelectionChangedListener {

	private static final Trace log = Trace.register(TBuyTdTradingPageHeaderView.class);
