...
public class NewsAccountViewFieldBinding extends BasicFieldBinding implements IObservableListDataProvider{

	private IListDataProvider listAdapter;
	private IDataChangedListener listener;
	public NewsAccountViewFieldBinding(IAndroidBindingContext ctx, String fieldName,
	...
	public void activate(IView model) {
		...
		if(listAdapter != null){
			...
			((NewsAccountView)getUIControl()).setDataProvider(this);
		}
	}
	...
	public void deactivate() {
		if(this.listAdapter != null){
			((NewsAccountView)getUIControl()).setDataProvider(null);
