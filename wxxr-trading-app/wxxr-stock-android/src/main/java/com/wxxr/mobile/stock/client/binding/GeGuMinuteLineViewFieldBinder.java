 ...
 *
 */
public class GeGuMinuteLineViewFieldBinder implements IFieldBinder {
	...
	public IFieldBinding createBinding(IBindingContext context,String fieldName,
		...
		return new GeGuMinuteLineViewFieldBinding((IAndroidBindingContext)context, fieldName, attrs);
	}
