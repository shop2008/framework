...
@View(name="T3RuleWebPage",withToolbar=true,description="文章正文")
@AndroidBinding(type=AndroidBindingType.ACTIVITY, layoutId="R.layout.web_page_layout")
public abstract class T3RuleWebPage extends PageBase implements IModelUpdater {

	static Trace log= Trace.getLogger(T3RuleWebPage.class);
	@Menu(items = { "left" })
...
//	
	@Bean(express="${articleService.getT3TradingRuleArticle()}")
