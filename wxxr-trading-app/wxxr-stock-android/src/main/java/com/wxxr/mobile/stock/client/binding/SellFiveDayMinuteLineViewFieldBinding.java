...
public class SellFiveDayMinuteLineViewFieldBinding extends BasicFieldBinding implements IObservableListDataProvider{

	private IListDataProvider listAdapter;
	private IDataChangedListener listener;
	public SellFiveDayMinuteLineViewFieldBinding(IAndroidBindingContext ctx,
	...
	public void activate(IView model) {
		...
		if(listAdapter != null){
			((SellFiveDayMinuteLine)getUIControl()).setDataProvider(this);
		}
	...
	public void deactivate() {
		if(this.listAdapter != null){
			((SellFiveDayMinuteLine)getUIControl()).setDataProvider(null);
	...
	protected void updateUI(boolean arg0) {
		...
		SellFiveDayMinuteLine view = (SellFiveDayMinuteLine)getUIControl();
		
		Long buyPrice = comp.getAttribute(MinuteLineViewKeys.buyPrice);
		if(buyPrice!=null){
			view.setBuyPrice(buyPrice);
		}
