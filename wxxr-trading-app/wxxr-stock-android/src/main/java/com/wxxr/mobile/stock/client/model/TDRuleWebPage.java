...
@View(name="TDRuleWebPage",withToolbar=true,description="文章正文")
@AndroidBinding(type=AndroidBindingType.ACTIVITY, layoutId="R.layout.web_page_layout")
public abstract class TDRuleWebPage extends PageBase implements IModelUpdater {

	static Trace log= Trace.getLogger(TDRuleWebPage.class);
	@Menu(items = { "left" })
...
//	
	@Bean(express="${articleService.getTDTradingRuleArticle()}")
