...
public class CompoundButtonCheckChangeEventBinder implements IEventBinder {
	...
	public IEventBinding createBinding(IBindingContext context,
		...
		return new CompoundButtonCheckChangeEventBinding(ctx.getBindingControl(), cmdName, fieldName);
	}
