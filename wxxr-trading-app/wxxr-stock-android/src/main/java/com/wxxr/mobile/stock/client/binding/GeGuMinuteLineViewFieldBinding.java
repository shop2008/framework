...
public class GeGuMinuteLineViewFieldBinding extends BasicFieldBinding implements IObservableListDataProvider{

	private IListDataProvider listAdapter;
	private IDataChangedListener listener;
	public GeGuMinuteLineViewFieldBinding(IAndroidBindingContext ctx,
	...
	public void activate(IView model) {
		...
		if(listAdapter != null){
			((GMinuteLineView)getUIControl()).setDataProvider(this);
		}
	...
	public void deactivate() {
		if(this.listAdapter != null){
			((GMinuteLineView)getUIControl()).setDataProvider(null);
	...
	protected void updateUI(boolean arg0) {
		...
		if(comp!=null){
			GMinuteLineView view = (GMinuteLineView)getUIControl();
