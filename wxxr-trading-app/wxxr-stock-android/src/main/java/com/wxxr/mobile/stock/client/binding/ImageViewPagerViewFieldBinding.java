...
public class ImageViewPagerViewFieldBinding extends BasicFieldBinding implements IObservableListDataProvider{

	private IListDataProvider listAdapter;
	private IDataChangedListener listener;
	public ImageViewPagerViewFieldBinding(IAndroidBindingContext ctx,
	...
	public void activate(IView model) {
		...
		if(listAdapter != null){
			((imageViewPager)getUIControl()).setDataProvider(this);
		}
	...
	public void deactivate() {
		if(this.listAdapter != null){
			((imageViewPager)getUIControl()).setDataProvider(null);
