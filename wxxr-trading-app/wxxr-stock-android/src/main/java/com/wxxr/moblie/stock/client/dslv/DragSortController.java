...
public class DragSortController extends SimpleFloatViewManager implements View.OnTouchListener, GestureDetector.OnGestureListener {
    ...
    private int mTopHandleHitPos = MISS;
    ...
    public DragSortController(DragSortListView dslv, int dragHandleId, int dragInitMode, int removeMode, int clickRemoveId, int topHandleId) {
        this(dslv, dragHandleId, dragInitMode, removeMode, clickRemoveId, 0, topHandleId);
    }
    /**
    ...
    public DragSortController(DragSortListView dslv, int dragHandleId, int dragInitMode,
            int removeMode, int clickRemoveId, int flingHandleId, int topHandleId) {
        super(dslv);
        mDslv = dslv;
    ...
    public void setTopHandleId(int id){
    	mTopHandleId = id;
    }
    ...
    public boolean onDown(MotionEvent ev) {
        if (mRemoveEnabled && mRemoveMode == CLICK_REMOVE) {
            ...
            mTopHandleHitPos = viewIdHitPosition(ev, mTopHandleId);
        }
    ...
    public boolean onSingleTapUp(MotionEvent ev) {
        if (mRemoveEnabled && mRemoveMode == CLICK_REMOVE) {
            ...
            if(mTopHandleHitPos != MISS){
            	mDslv.moveTopItem(mTopHandleHitPos - mDslv.getHeaderViewsCount());
            }
        }
        return true;
    }
