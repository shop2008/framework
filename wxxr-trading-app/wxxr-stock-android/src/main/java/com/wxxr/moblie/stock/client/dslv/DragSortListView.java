...
package com.wxxr.moblie.stock.client.dslv;
...
public class DragSortListView extends ListView {
    ...
    private MoveTopListener mMoveTopListener;
        ...
        if (attrs != null) {
            ...
            if (useDefault) {
                ...
                int dragHandleId = a.getResourceId(
                        ...
                        0);
                int topHandleId = a.getResourceId(
                        R.styleable.DragSortListView_top_handle_id,
                        0);
                ...
                DragSortController controller = new DragSortController(
                        ...
                        clickRemoveId, flingHandleId, topHandleId);
    ...
    public void setAdapter(ListAdapter adapter) {
        if (adapter != null) {
            ...
            if (adapter instanceof MoveTopListener) {
                setMoveTopListener((MoveTopListener) adapter);
            }
    ...
    public void moveTopItem(int which){
    	if(mMoveTopListener!=null){
    		mMoveTopListener.moveTop(which);
    	}
    }
    /**
    ...
    public void setMoveTopListener(MoveTopListener l){
    	mMoveTopListener = l;
    }
    ...
    public interface MoveTopListener {
        public void moveTop(int top);
    }

    public interface DragSortListener extends DropListener, DragListener, RemoveListener, MoveTopListener {
    }
