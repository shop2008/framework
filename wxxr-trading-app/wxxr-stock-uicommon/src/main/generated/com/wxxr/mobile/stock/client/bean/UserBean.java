...
public class UserBean implements IBindableBean {
	...
	/**
	 * @return the tradeInfos
	 */
	public List<TradingAccountBean> getTradeInfos() {
		return tradeInfos;
	}

	/**
	 * @param tradeInfos the tradeInfos to set
	 */
	public void setTradeInfos(List<TradingAccountBean> tradeInfos) {
		List<TradingAccountBean> old = this.tradeInfos;
		this.tradeInfos = tradeInfos;
		this.emitter.firePropertyChange("tradeInfos", old, this.tradeInfos);
	}
